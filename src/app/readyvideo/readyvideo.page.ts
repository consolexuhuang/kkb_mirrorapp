...
export class ReadyvideoPage implements OnInit {
  ...
  videoInfo:any = [
    ...
    {id:51, coursename:'Yoga Flow流瑜伽-Vol.1', coach:'乐仔',banner:'https://img.cdn.powerpower.net/5e942430e4b0b9999a226d27.png', courseinfo:'流瑜伽是瑜伽的一种，侧重身体伸展柔韧性，力量与耐力，平衡与专注力。动作像行云流水一样，缓慢流畅。体式之间的衔接给人一气呵成的感觉。流瑜伽强调运动与呼吸的和谐性，每个动作停留3到5个呼吸。仔细体会身体的感受、专注力与动作流动的全面锻炼，让每个核心体式都能使用不同的连接体式（vinyasa）进行紧密串联，同时也穿插了快速地节拍性动作组合。', coursetags:['中强度','瑜伽','伸展','新手推荐']},
    {id:52, coursename:'BODYCOMBAT燃脂搏击', coach:'Lisa',banner:'https://img.cdn.powerpower.net/5e9423bbe4b0b9999a226d22.png', courseinfo:'BODYCOMBAT将搏击和有氧训练结合，动作和音乐经过顶级教练员、运动生理专家、编辑师精心研究，不仅安全有效，还易于掌握。无论是平时缺乏锻炼、身材娇小、体质瘦弱的白领女性，还是身体强壮的男性，都非常适合参与，通过课程达到燃脂瘦身，放松减压的目的。', coursetags:['高强度','燃脂','徒手训练','热门课程']},
